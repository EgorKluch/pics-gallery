...
_.extend(UserManager.prototype, {
  ...
  getByLogin: function (login, next) {
  ...
  signIn: function (login, password, next) {
    var self = this;
  ...
  _checkUserOnExists: function (login, email, next) {
    var self = this;
  ...
  _getHashedPassword: function (password) {
